...
public class SO_TC02_Stepdef extends Base {
	...
	String Invamount = SO_TC02_data.get(17).get("Column13").replace("₹", "").replace(",", "");
	...
	public void validate_Quotes_SubTotal_GrandTotal_SO_TC_Two() throws InterruptedException {
		Sales_Quotes_Edit.SO_Accept_Quote("SO_TC02");
	...
	public void convert_Sales_Quotes_into_Sales_Order_SO_TC_Two() {
		Sales_Quotes_View.createOrder(SO_TC02_data,"SO_TC02");
	...
	public void invoice_Posting_for_Generated_Invoices_SO_TC_Two() throws Exception {
	...
	public void receipts_Partial_Receipt_for_One_Invoice_and_Full_Receipt_for_Remaining_Invoices_SO_TC_Two() throws InterruptedException {
		AR_Receipts.Receipts(SO_TC02_data, "SO_TC02", "FullPayment", 15, "INR", Invamount);
