...
public class SO_TC11_Stepdef extends Base {
	...
	String Invamount = SO_TC11_data.get(17).get("Column13").replace("₹", "").replace(",", "");
	...
	public void create_SO_SO_TC_Eleven() throws InterruptedException {
		Sales_SalesOrder.SO_StartOrder(SO_TC11_data, "SO Service", "-Select-");
...
//		Facilities_Shipments.SO_CreateShipment(SO_TC11_data, "SO_TC11", "Column25", "Column26", "Column27", 15, 0);
		Facilities_Shipments.SO_CreateShipment1_TC11(SO_TC11_data);
	}
...
//		Facilities_Shipments.SO_CreateShipment(SO_TC11_data, "SO_TC11", "Column37", "Column38", "Column39", 16, 0);
		Facilities_Shipments.SO_CreateShipment2_TC11(SO_TC11_data);
	}
...
//		Facilities_Shipments.SO_CreateShipment(SO_TC11_data, "SO_TC11", "Column49", "Column50", "Column51", 17, 2);
		Facilities_Shipments.SO_CreateShipment3_TC11(SO_TC11_data);
		Sales_SalesOrder_View.SO_CaptureInvoiceID("SO_TC11");
	}
	...
	public void invoice_Posting_for_Generated_Invoices_SO_TC_Eleven() throws Exception {
	...
	public void receipts_Partial_Receipt_for_One_Invoice_and_Full_Receipt_for_Remaining_Invoices_SO_TC_Eleven() throws InterruptedException {
		AR_Receipts.Receipts(SO_TC11_data, "SO_TC11", "FullPayment", 15, "INR", Invamount);
