...
public class SO_TC06_Stepdef extends Base {
	...
	String Invamount = SO_TC06_data.get(16).get("Column11").replace("$", "").replace(",", "");
	// @SO_TC06-01
	...
	public void create_SO_SO_TC_Six() throws InterruptedException {
	...
	public void receipts_Full_Receipt_for_Remaining_Invoices_after_Adjustments_SO_TC_Six() throws InterruptedException {
		...
		AR_Receipts.Receipts(SO_TC06_data, "SO_TC06", "FullPayment", 16, "USD", Invamount);
