...
public class STO_TC07_Stepdef extends Base {
	List<HashMap<String, String>> data = CrestTestDataReader.get_STO_TC07_Data();
...
// Scenario: Create Stock transfer Order - STO_TC07
	...
	public void create_new_stock_transfer_order() throws Throwable {
	    Facilities_StockManagement_StockReceipt.unplannedStockReceipt(data, 4, excelPath, "STO_TC07", 12, 14);
		Sales_Create_STO_Order.createSTO(data,"STO_TC07");
	}
	...
	public void Review_and_Create_STO() throws Throwable {
		Sales_Create_STO_Order.reviewSTO(excelPath,"STO_TC07");
	}
...
//	Scenario: Create a Shipment - STO_TC07
	...
	{
		Sales_Stock_Transfer_Order_View.creatfirstOutgoingShip(data,"STO_TC07","Column14","Column15","Column16",12,excelPath,"STO_TC07");
	}
	...
	{
		Sales_Stock_Transfer_Order_View.capture_InvoiceId(excelPath,"STO_TC07",12,9);
	}
...
// Scenario: Receive the Transfer Incoming Shipment - STO_TC07
	...
	{
		Sales_Stock_Transfer_Order_View.createIncomingShp1(excelPath,"STO_TC07",12);
	}
	
	@Then("^Receive the inventory - STO_TC_SEVEN_four$")
	public void receiveOrderItem()
	{
		Sales_Stock_Transfer_Order_View.receiveInventory("STO_TC07");
	}
