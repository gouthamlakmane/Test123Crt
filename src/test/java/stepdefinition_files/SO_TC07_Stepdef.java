...
public class SO_TC07_Stepdef extends Base {
	...
	String Invamount = SO_TC07_data.get(16).get("Column11").replace("$", "").replace(",", "");
	String Invamount1 = SO_TC07_data.get(13).get("Column11").replace("$", "").replace(",", "");
	// @SO_TC07-01
	...
	public void create_SO_SO_TC_Seven() throws InterruptedException {
	...
	public void invoice_Posting_for_Generated_Invoices_SO_TC_Seven() throws Exception {
	...
	public void receipts_One_Invoice_with_Exchange_Rate_of_X_SO_TC_Seven() throws InterruptedException {
		AR_Receipts.Receipts(SO_TC07_data, "SO_TC07", "ExchangeRate", 15, "USD", Invamount1);
	...
	public void receipts_Remaining_Invoice_with_Exchange_Rate_of_X_plus_Five_Percent_SO_TC_Seven() throws InterruptedException {
		AR_Receipts.Receipts(SO_TC07_data, "SO_TC07", "FullPayment", 16, "USD", Invamount);
