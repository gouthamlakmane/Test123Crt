...
public class SO_TC01_Stepdef extends Base {
	...
	String Invamount = SO_TC01_data.get(17).get("Column13").replace("₹", "").replace(",", "");
	// @SO_TC01-01
	...
	public void validate_Quotes_SubTotal_GrandTotal_SO_TC_One() throws InterruptedException {
		Sales_Quotes_Edit.SO_Accept_Quote("SO_TC01");
	...
	public void convert_Sales_Quotes_into_Sales_Order_SO_TC_One() {
		Sales_Quotes_View.createOrder(SO_TC01_data, "SO_TC01");
	...
	public void invoice_Posting_Single_Invoice_SO_TC_One() throws Exception {
	...
	public void receipts_Single_Receipt_SO_TC_One() throws InterruptedException {
		AR_Receipts.Receipts(SO_TC01_data, "SO_TC01", "FullPayment", 15, "INR", Invamount);
