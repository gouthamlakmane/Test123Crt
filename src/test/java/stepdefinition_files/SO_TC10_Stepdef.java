...
public class SO_TC10_Stepdef extends Base {
	...
	String Invamount = SO_TC10_data.get(17).get("Column13").replace("₹", "").replace(",", "");
	// @SO_TC10-01
	// Scenario: Create Service SO with Offline Payment - SO_TC10

	@Given("^Create SO - SO_TC_Ten$")
	public void create_SO_SO_TC_Ten() throws InterruptedException {
	...
	public void invoice_Posting_for_Generated_Invoices_SO_TC_Ten() throws Exception {
	...
	public void receipts_Partial_Receipt_for_One_Invoice_and_Full_Receipt_for_Remaining_Invoices_SO_TC_Ten() throws InterruptedException {
		AR_Receipts.Receipts(SO_TC10_data, "SO_TC10", "PartialPayment", 15, "INR", Invamount);
