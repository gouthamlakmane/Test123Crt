...
public class Facilities_Shipments extends Base {
	...
	public static void SO_CreateShipment1_TC11(List<HashMap<String, String>> data) throws InterruptedException {

		WebdriverWait.findElement("xpath", "//*[text()='Sales']").click();
		WebdriverWait.findElement("xpath", "//*[text()=' Sales Order']").click();
		WebdriverWait.findElement("id", "orderId").sendKeys(data.get(13).get("Column4"));
		WebdriverWait.findElement("xpath", "//*[@Value='Search']").click();
		WebdriverWait.findElement("xpath", "//*[@id='example_wrapper']//table//tbody/tr[1]/td[2]/a").click();

		WebdriverWait.findElement("xpath", "//*[text()='Generate Service Order Invoice']").click();

		List<WebElement> Invoiceitems = WebdriverWait.findElements("xpath",
				"//*[@id='serviceInvoiceContainer']//table/tbody/tr");

		for (int i = 1; i <= Invoiceitems.size(); i++) {

			String product = WebdriverWait
					.findElement("xpath", "//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[3]")
					.getText();
//			System.out.println(product);
			String prdid = product.substring(0, 5);
//			System.out.println(prdid);

			if (prdid.equals(data.get(0).get("Column25"))) {
				WebdriverWait.findElement("xpath","//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[7]/input").clear();
				WebdriverWait.findElement("xpath","//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[7]/input")
						.sendKeys(data.get(0).get("Column27"));
				WebdriverWait.findElement("xpath", "//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[1]").click();
				
						
			}

			else if (prdid.equals(data.get(1).get("Column25"))) {
				WebdriverWait.findElement("xpath","//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[7]/input").clear();
				WebdriverWait.findElement("xpath","//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[7]/input")
						.sendKeys(data.get(1).get("Column27"));
				WebdriverWait.findElement("xpath", "//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[1]").click();
			} 

		}

			WebdriverWait.findElement("xpath", "//*[@Value='Create Invoice']").click();
	}
	
	public static void SO_CreateShipment2_TC11(List<HashMap<String, String>> data) throws InterruptedException {
		...
		for (int i = 1; i <= Invoiceitems.size(); i++) {
			...
			String product = WebdriverWait.findElement("xpath", "//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[3]").getText();
			String prdid = product.substring(0, 5);

			if (prdid.equals(data.get(0).get("Column37"))) {
				WebdriverWait.findElement("xpath","//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[7]/input").clear();
				WebdriverWait.findElement("xpath","//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[7]/input")
						.sendKeys(data.get(0).get("Column39"));
				WebdriverWait.findElement("xpath", "//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[1]").click();
			}

			else if (prdid.equals(data.get(1).get("Column37"))) {
				WebdriverWait.findElement("xpath","//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[7]/input").clear();
				WebdriverWait.findElement("xpath","//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[7]/input")
						.sendKeys(data.get(1).get("Column39"));
				WebdriverWait.findElement("xpath", "//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[1]").click();
			} 
		}
	...
	public static void SO_CreateShipment3_TC11(List<HashMap<String, String>> data) throws InterruptedException {
		...
		for (int i = 1; i <= Invoiceitems.size(); i++) {
			...
			if (prdid.equals(data.get(0).get("Column49"))) {
				WebdriverWait.findElement("xpath","//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[7]/input").clear();
				WebdriverWait.findElement("xpath","//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[7]/input")
						.sendKeys(data.get(0).get("Column51"));
				WebdriverWait.findElement("xpath", "//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[1]").click();
			}

			else if (prdid.equals(data.get(1).get("Column49"))) {
				WebdriverWait.findElement("xpath","//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[7]/input").clear();
				WebdriverWait.findElement("xpath","//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[7]/input")
						.sendKeys(data.get(1).get("Column51"));
				WebdriverWait.findElement("xpath", "//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[1]").click();
			} 
			
			else if (prdid.equals(data.get(2).get("Column49"))) {
				WebdriverWait.findElement("xpath","//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[7]/input").clear();
				WebdriverWait.findElement("xpath","//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[7]/input")
						.sendKeys(data.get(2).get("Column51"));
				WebdriverWait.findElement("xpath", "//*[@id='serviceInvoiceContainer']//table/tbody/tr[" + i + "]/td[1]").click();
			} 
	...
	public static void SO_CreateShipment(List<HashMap<String, String>> data, String sheetname, String prdID, String ordQty_colnum, String plndQty_colnum,
		...
		if(sheetname.equals("AC_SO_TC12"))
		{
			Facilities_Shipments_OrderItems.SO_Issue_Shpmnt1(data, plndQty_colnum);
		}
		else {
...
//		Lakshmi(Data Modified in Excel)
	...
	public static void AddtlShippingChargeDesc_255charac_Val(List<HashMap<String, String>> data, List<HashMap<String, String>> data1) {
		...
		WebdriverWait.findElement("id", "addtlShippingChargeDesc").sendKeys(data.get(32).get("Column1"));
		WebdriverWait.findElement("id", "createSubmit").click();
		String desc = WebdriverWait.findElement("xpath", "//*[@id= 'content-messages']/div/ul/li[1]").getText();
		purchaseShipment_softAssert.assertThat(desc).isEqualTo(data.get(33).get("Column13"));
	...
	public static void EstimatedArrival_Val(List<HashMap<String, String>> data, List<HashMap<String, String>> data1) {
		...
		purchaseShipment_softAssert.assertThat(estimatedArrival_Date).isEqualTo(data.get(33).get("Column13"));
...
//		WebdriverWait.findElement("id", "addtlShippingChargeDesc").sendKeys(Inv_data.get(6).get("Column1"));
		WebdriverWait.findElement("id", "addtlShippingChargeDesc").sendKeys(Inv_data.get(32).get("Column1"));
...
//		purchaseShipment_softAssert.assertThat(addshipchargDesc).isEqualTo(Inv_data.get(5).get("Column13"));
		purchaseShipment_softAssert.assertThat(addshipchargDesc).isEqualTo(Inv_data.get(33).get("Column13"));
