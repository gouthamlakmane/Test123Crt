...
public class AP_Payments_Overview extends Base {
	...
	public static void ConfirmPayment() {
		...
		String Pymt_Status = WebdriverWait
				.findElement("xpath", "//*[@id='content-main-section']/div[2]/div[2]/table/tbody[1]/tr[1]/td[4]")
				.getText();
		...
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[4]/div[2]/table/tbody/tr[2]/td[3]/a")
				.click();// Click POnum
	}
	...
	public static void SentPayment() {
		...
		String Pymt_Status = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[2]/div[2]/table/tbody[1]/tr[1]/td[4]").getText();
