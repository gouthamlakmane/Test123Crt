...
public class AP_Payments_Applications extends Base {
	...
	public static void SelectInvoiceID(List<HashMap<String, String>> data, String PaymentType) throws InterruptedException 
	{
		...
		for (int y = 2; y <= Inv_Pay_tble.size(); y++) 
		{
			...
			String after_xpath = "]/td";
		    	...
		    	WebElement ec   = WebdriverWait.findElement("xpath", "//*[@id='example5']/tbody/tr["+y+"]/td");
			CallJavascriptExecutor.scrollToElement(ec);
			totalTabletext= WebdriverWait.findElement("xpath", "//*[@id='example5']/tbody/tr["+y+"]/td").getText();
			 System.out.println("invoice id from GUI: "+totalTabletext);
            Thread.sleep(1000);
		 if (Invlist.contains(totalTabletext)) 
			  {
				...
				{
			     WebElement element	=	WebdriverWait.findElement("xpath", "//*[@id='example5']/tbody/tr["+y+"]/td[8]/input");
			     ...
			     element.click();
			 ...
			 else if (PaymentType.contains("PartialPayment")) 
				    {
						...
						WebdriverWait.findElement("xpath", "//*[@id='example5']/tbody/tr["+y+"]/td[8]/input").click();
	...
	public static void SelectInvoiceID_PayTerm(List<HashMap<String, String>> data) throws InterruptedException {
		...
		List<WebElement> Inv_Pay_tble = WebdriverWait.findElements("xpath", "//*[@id='example5']/tbody/tr");
		System.out.println("Inv_Pay_tble size: "+Inv_Pay_tble.size());
		
		String totalTabletext = null;
		String payTermText = null;

		for (int y = 1; y <= Inv_Pay_tble.size(); y++) 
		{
			totalTabletext = WebdriverWait.findElement("xpath", "//*[@id='example5']/tbody/tr["+y+"]/td[1]").getText();
			payTermText    = WebdriverWait.findElement("xpath", "//*[@id='example5']/tbody/tr["+y+"]/td[4]").getText();
			...
			if (Invlist.contains(totalTabletext) && (payTermText.contains("Payment net days, part 1"))) 
			  {
					...
					WebElement ele=WebdriverWait.findElement("xpath", "//*[@id='example5']/tbody/tr["+y+"]/td[8]/input");
		...
		else if (Invlist.contains(totalTabletext) && (payTermText.contains("Payment net days, part 2")))
			{
				String before_xpath1 = "//*[@id='example5']/tbody/tr[";
				String after_xpath1 = "]/td[8]/input";
				WebElement ele1= WebdriverWait.findElement("xpath", "//*[@id='example5']/tbody/tr["+y+"]/td[8]/input");
				CallJavascriptExecutor.scrollToElement(ele1);
				CallJavascriptExecutor.highLighterElement(ele1);
				Thread.sleep(1000);
				ele1.click();
				}
	...
	public static void removeAddedLineItem() {
		...
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[3]/div[2]/table/tbody/tr[2]/td[6]/a").click();

		Alert alert = driver.switchTo().alert();
		alert.accept();

		String noRecords = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[3]/div[2]/table/tbody/tr[2]/td").getText();
