...
public class AP_PurchaseInvoices_Items extends Base {
	...
	public static void MandatoryFields_Val(List<HashMap<String, String>> data) {
		...
		PI_Items_softAssert.assertThat(qtyReq).isEqualTo(data.get(25).get("Column10"));
	...
	public static void desc_255Charc_Val(List<HashMap<String, String>> data) {
		...
		String charcLimit = WebdriverWait.findElement("xpath", "//input[@id='description']").getAttribute("value");
		PI_Items_softAssert.assertThat(charcLimit.length()).isEqualTo(510);
...
//		Lakshmi
		PI_Items_softAssert.assertThat(qty_grt0).isEqualTo(data.get(33).get("Column10"));
//		PI_Items_softAssert.assertThat(qty_grt0).isEqualTo(data.get(1).get("Column10"));
		...
		PI_Items_softAssert.assertThat(qty_grt).isEqualTo(data.get(33).get("Column10"));
...
//		Lakshmi
		PI_Items_softAssert.assertThat(qty_num1).isEqualTo(data.get(34).get("Column10"));
//		PI_Items_softAssert.assertThat(qty_num1).isEqualTo(data.get(2).get("Column10"));
	...
	public static void Invalid_UnitPrice(List<HashMap<String, String>> data) {
		...
		PI_Items_softAssert.assertThat(UnitPrice_grt0).isEqualTo(data.get(2).get("Column9"));
		...
		PI_Items_softAssert.assertThat(UnitPrice_grt).isEqualTo(data.get(2).get("Column9"));
...
//		PI_Items_softAssert.assertThat(qty_num1).isEqualTo(data.get(2).get("Column10"));
	...
	public static void InvalidUnitPrice_LineItem(List<HashMap<String, String>> data) {
		...
		WebdriverWait.findElement("name", "update").click();
		String qty_grt0 = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/p").getText();
//		PI_Items_softAssert.assertThat(qty_grt0).isEqualTo(data.get(24).get("Column12"));

		// 0 Value
		WebdriverWait.findElement("id", "amount_o_1").clear();
		WebdriverWait.findElement("id", "amount_o_1").sendKeys(data.get(3).get("Column1"));
		WebdriverWait.findElement("name", "update").click();
		String qty_grt = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/p").getText();
//		PI_Items_softAssert.assertThat(qty_grt).isEqualTo(data.get(24).get("Column12"));
		...
		String qty_num1 = WebdriverWait.findElement("xpath", "//*[@id= 'content-messages']/div/ul/li[1]").getText();
//		Lakshmi
		PI_Items_softAssert.assertThat(qty_num1).isEqualTo(data.get(32).get("Column12"));
		...
		PI_Items_softAssert.assertThat(qtyReq).isEqualTo(data.get(11).get("Column12"));
	...
	public static void Remove_LineItems() {
		...
		rows2.size();
//		Lakshmi
		PI_Items_softAssert.assertThat(rows2.size()).isEqualTo(rows1.size());
