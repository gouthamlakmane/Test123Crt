...
public class Sales_SalesOrder_View extends Base {
	...
	public static void Capture_SONum(String sheetname) {
		...
		String so_Num = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[2]/div[2]/table/tbody/tr[1]/td[2]/a").getText();
	...
	public static void Capture_SONum_Negative_Facility(String sheetname) {
		String so_Num = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[2]/div[2]/table/tbody/tr[1]/td[2]/a").getText();
		System.out.println("SO Number = " + so_Num);
		so_Number = so_Num;
		ExcelWriter.writeExcelFile(sheetname, 16, 4, so_Num);
		WebdriverWait.findElement("xpath", "//*[.='Approve Order']").click();
	...
	public static void Approve_SO(List<HashMap<String, String>> data) {
		...
		WebdriverWait.findElement("xpath", "//*[text()='Approve Order']").click();
	...
	public static void SO_CaptureInvoiceID(String sheetname) {

		WebdriverWait.findElement("xpath", "//*[@id='serviceSalesHeaderContainer']/table/tbody/tr[1]/td[2]/a").click();
		List<WebElement> CapInvoice = WebdriverWait.findElements("xpath","(//*[@class='screenlet-body'])[5]/table/tbody/tr");
		int j = 15;
		for (int i = 1; i <= CapInvoice.size(); i++) {

			String Invoiceid = WebdriverWait.findElement("xpath", "(//*[@class='screenlet-body'])[5]/table/tbody/tr[" + i + "]/td[6]/a").getText();
//			System.out.println(Invoiceid);
			ExcelWriter.writeExcelFile(sheetname, j, 6, Invoiceid);
			j++;
		}
	}
	...
	public static void SO_CaptureInvID(String sheetname) {
		...
		List<WebElement> InvTable = WebdriverWait.findElements("xpath", "//*[@id='content-main-section']/div[5]/div[2]/table/tbody/tr");

		int j = 15;
		for (int Inv = 1; Inv <= InvTable.size(); Inv++) {

			String InvID = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[5]/div[2]/table/tbody/tr[" + Inv + "]/td[6]/a").getText();
	...
	public static void PayTerm_Val(List<HashMap<String, String>> data) {
		...
		try {
			CallJavascriptExecutor.scrollToElement(WebdriverWait.findElement("xpath", "//*[@id='orderTermsOriginal']/tbody/tr[1]/td[5]"));
		...
		System.out.println(WebdriverWait.findElement("xpath", "//*[@id='orderTermsOriginal']/tbody/tr[1]/td[5]").getText());
		
		SO_View_softAssert.assertThat(payterm1).as("Payterm1 validation is not matching").isEqualTo(data.get(17).get("Column18"));

		String payterm2 = WebdriverWait.findElement("xpath", "//*[@id='orderTermsOriginal']/tbody/tr[2]/td[5]").getText().replace(",", "");
		SO_View_softAssert.assertThat(payterm2).as("Payterm2 validation is not matching").isEqualTo(data.get(17).get("Column19"));
	...
	public static void SO_SubTotal_Val(List<HashMap<String, String>> data, String Header) {
		...
		List<WebElement> orderItemsTable = WebdriverWait.findElements("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr");
		System.out.println(orderItemsTable.size());

		for (int a = 1; a <= orderItemsTable.size(); a++) {

			String subTotal = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr[" + a + "]/td[2]").getText();

			if (subTotal.contains("Sub Total")) {

				String SubTotal = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr[" + a + "]/td[3]").getText()
								.replace(",", "");
				System.out.println("SubTotal" + SubTotal);
				SO_View_softAssert.assertThat(data.get(17).get(Header)).as("Sales order Sub Total Vaidation is not matching").isEqualTo(SubTotal);
	...
	public static void SO_GrdTotal_Val(List<HashMap<String, String>> data, String Header) {
		...
		for (int a = 1; a <= orderItemsTable.size(); a++) {
			...
			if (grandTotal.contains("Grand Total")) {
				...
				SO_View_softAssert.assertThat(data.get(17).get(Header)).as("Sales Order Grand total is not matching").isEqualTo(GrandTotal);
	...
	public static void Tax_Consolidated_PopupBtn_Val(List<HashMap<String, String>> data) {
		...
		SO_View_softAssert.assertThat(data.get(17).get("Column16")).as("validating the Tax(Consolidated) button").isEqualTo(TotalTax);
		...
		for (int a = 1; a <= orderItemsTable.size(); a++) {
			...
			if (totalTax.contains("Tax Amount (Consolidated)")) {
				...
				String TotalTax = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[6]/div[2]/table/tbody/tr[" + a + "]/td[3]").getText()
								.replace(",", "");
				SO_View_softAssert.assertThat(data.get(17).get(Header)).as("Total tax is not matching: ").isEqualTo(TotalTax);
	...
	public static void TaxBreakup_Table_Val(List<HashMap<String, String>> data) {
		...
		if (taxType.equalsIgnoreCase("INTRA")) {
			...
			SO_View_softAssert.assertThat(data.get(24).get("Column23")).as("The value inside the tax breakup table is not matching").isEqualTo(totalTax);
	...
	public static void ThirdPartyCharges_Table_Val(List<HashMap<String, String>> data) {
		...
		String thirdPartyTotalCharges = WebdriverWait.findElement("xpath", "//*[@id='tab_tab1_charges']/table/tbody/tr[" + b + "]/td[2]").getText().replace(",",
						"");
		SO_View_softAssert.assertThat(thirdPartyTotalCharges).as("Third party table charges not matching: ").isEqualTo(data.get(26).get("Column3"));
	...
	public static void click_firstLineItem_ViewDetails() {
		...
		WebdriverWait.findElement("xpath", "(//*[@class='screenlet-body'])[7]/table/tbody/tr[1]/td[4]/a").click();
	}

	public static void capture_ReturnReplacementSO_ID(String sheetname) {
		String getReturnReplacment_SO_ID = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[5]//table/tbody/tr[6]/td[2]/a").getText();
		ExcelWriter.writeExcelFile(sheetname, 15, 2, getReturnReplacment_SO_ID);
	}

	public static void click_ReturnReplacementSO_ID() {
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[5]//table/tbody/tr[9]/td[2]/a").click();
	}
	...
	public static void verifySalesReturnInvoiceDetails_Prd_N_Qty(List<HashMap<String, String>> data) {
		...
		WebdriverWait.findElement("xpath", "//*[text()='Return Summary']").click();
		String getProductID =	WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[2]//table/tbody[2]/tr[1]/td[2]/a").getText();
		Assert.assertEquals(getProductID, data.get(0).get("Column25"));

		String getReturnedQty =	WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[2]//table/tbody[2]/tr[1]/td[5]").getText();
	...
	public static void verify_ReturnReplacementSO_GrdTotal_Value(List<HashMap<String, String>> data) {
		...
		String grandTotal_actual = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[2]//table/tbody[2]/tr[5]/td[3]").getText();
			System.out.println("GrandTotal" + grandTotal_actual);
			SO_View_softAssert.assertThat("₹84,417.83").isEqualTo(grandTotal_actual);
				log.info("Grand Total validated Successfully");
				System.out.println("Grand Total Validated Successfully");
	}
...
//		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[6]/div[2]/table/tbody/tr/td[7]/input").click();
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr/td[6]").click();
//		String actMsg = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li").getText();
		String actMsg = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li[2]").getText();
...
//		WebElement Qty = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/form[1]/table/tbody/tr[1]/td[6]/input");
		WebElement Qty = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[8]/div[2]//table/tbody/tr[1]/td[6]//*[@type='text']");
		Qty.clear();
...
//			SO_View_softAssert.fail("Validation msg is not displayed when Recalculate Selected with SPL character as Qty");
	...
	public static void Validate_RecalculateSelected_lineItem_Discount_with_emptyValue(List<HashMap<String, String>> data) {
		...
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[8]/div[2]//table/tbody/tr[1]/td[12]//*[@type='text']").clear();
		WebdriverWait.findElement("id", "selectedItem_1").click();
		WebdriverWait.findElement("link", "Recalculate Selected").click();
		try {
			if (WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li").isDisplayed()) {
...
//			SO_View_softAssert.fail("Validation msg is not displayed when Recalculate Selected by leaving discount field as empty");
	...
	public static void Validate_RecalculateSelected_lineItem_without_DiscountType_with_DiscountValue(List<HashMap<String, String>> data) {
		...
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[8]/div[2]//table/tbody/tr[1]/td[12]//*[@type='text']")
...
//		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[14]/div[2]/table/tbody/tr/td[2]/a[1]").click();
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[15]/div[2]/table/tbody/tr/td[2]/a[1]").click();
...
//		SO_View_softAssert.assertThat(actAlertMsg).isEqualTo(data.get(12).get("Column10"));
		SO_View_softAssert.assertThat(actAlertMsg).isEqualTo("Note Description is required.");
		WebdriverWait.findElement("link", "Back to Order").click();
	}
	...
	public static void Validate_Delete_OtherDetails(List<HashMap<String, String>> data) {
		EditOrderLink();
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[15]/div[2]/table/tbody/tr/td[2]/a[2]").click();
	...
	public static void CreateAsNewOrder() {
		String tax = WebdriverWait.findElement("xpath", "//*[@id='myBtn']/../following-sibling::td").getText();
...
//		String isLineItem4Cancelled = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[6]/div[2]/table/tbody/tr[4]/td[4]").getText();
		String isLineItem4Cancelled = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr[4]/td[4]").getText();
		SO_View_softAssert.assertThat(isLineItem4Cancelled).contains("Cancelled");
		String isLineItem5Cancelled = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr[5]/td[4]").getText();
		SO_View_softAssert.assertThat(isLineItem5Cancelled).contains("Cancelled");
		String actSubTotal = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr[6]/td[3]").getText();
		SO_View_softAssert.assertThat(actSubTotal).isEqualTo(data_Positive.get(17).get("Column15"));
		String actTax = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr[9]/td[3]").getText();
...
//		String actGrandTotal = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[6]/div[2]/table/tbody/tr[9]/td[3]/span").getText();
		String actGrandTotal = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr[9]/td[3]").getText();
...
//			WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[8]/div[2]/form/table/tbody/tr[7]/td/input").click();
			WebdriverWait.findElement("xpath", "//*[@name='submitItems']").click();
		}
		String actSubTotal = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[8]/div[2]/form[1]/table/tbody/tr[8]/td[3]").getText();
		SO_View_softAssert.assertThat(actSubTotal).isEqualTo(data_Positive_1.get(17).get("Column15"));
		String actTax = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[8]/div[2]/form[1]/table/tbody/tr[11]/td[3]").getText();
...
//						.getText();
		String actGrandTotal = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[8]/div[2]/form[1]/table/tbody/tr[11]/td[3]")
				.getText();
...
//		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/form[2]/table/tbody/tr[3]/td/input").click();
		WebdriverWait.findElement("xpath", "(//*[@value='Add'])[1]").click();		
...
//		SO_View_softAssert.assertThat(actAlertMsg1).isEqualTo(data.get(11).get("Column8"));
		...
		SO_View_softAssert.assertThat(actAlertMsg2).isEqualTo("Description is Required.");
		String actAlertMsg3 = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li[3]").getText();
		SO_View_softAssert.assertThat(actAlertMsg3).isEqualTo(data.get(31).get("Column12"));
	}
...
//		Select facility_dd = new Select(WebdriverWait.findElement("name", "shipGroupSeqId"));
		Select facility_dd = new Select(WebdriverWait.findElement("xpath", "(//*[@name='shipGroupSeqId'])[3]"));
		facility_dd.selectByValue("00001");
		WebElement description = WebdriverWait.findElement("xpath", "(//*[@name='description'])[4]");
		description.sendKeys(data.get(6).get("Column1"));
		WebdriverWait.findElement("xpath", "(//*[@name='amount'])[4]").sendKeys("5");
		WebdriverWait.findElement("xpath", "(//*[@value='Add'])[1]").click();
		String validationMsg = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li").getText();
//		SO_View_softAssert.assertThat(validationMsg).isEqualTo("The maximum limit for Description is 255 characters");
	}
	...
	public static void Validate_Edit_SO_with_Adj_Value_with_SPL_Characters(List<HashMap<String, String>> data) {
		...
		WebdriverWait.findElement("xpath", "(//*[@name='amount'])[4]").sendKeys(data.get(0).get("Column1"));
		WebdriverWait.findElement("xpath", "(//*[@value='Add'])[1]").click();
		String validationMsg = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li").getText();
...
//		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[8]/div[2]/form/table/tbody/tr[7]/td/input").click();
	...
	public static void Validate_edit_SO_under_AddOrderItem_section_Qty_with_SPL_characters(List<HashMap<String, String>> data) {
		...
		SO_View_softAssert.assertThat(actAlertMsg1).isEqualTo(data.get(7).get("Column3"));
		String actAlertMsg2 = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li[2]").getText();
		SO_View_softAssert.assertThat(actAlertMsg2).isEqualTo(data.get(40).get("Column10"));
	}
	...
	public static void Validate_edit_SO_under_AddOrderItem_section_with_Invalid_Date_Range(List<HashMap<String, String>> data_Positive,
		...
		WebdriverWait.findElement("id", "discount").sendKeys(data_Positive.get(0).get("Column17"));
		WebdriverWait.findElement("name", "itemComment").sendKeys("Test");
		WebdriverWait.findElement("xpath", "(//*[@name='shipAfterDate_i18n'])[2]").sendKeys(data.get(8).get("Column1"));
//		WebdriverWait.findElement("name", "itemComment").sendKeys(data.get(7).get("Column1"));
		WebdriverWait.findElement("xpath", "(//*[@name='shipBeforeDate_i18n'])").sendKeys(data.get(7).get("Column1"));
		WebdriverWait.findElement("xpath", "//*[@name='submitItems']").click();
		...
		String actAlertMsg1 = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li[3]").getText();
