...
//				Sales_Return_softAssert.assertThat(all_ValidationMsg).isEqualTo(data.get(8).get("Column5"));
				Sales_Return_softAssert.assertThat(all_ValidationMsg).isEqualTo(data.get(32).get("Column5"));
			} else if (i == 4) {
...
//		Sales_Return_softAssert.assertThat(actMsg).isEqualTo(data.get(10).get("Column5"));
		Sales_Return_softAssert.assertThat(actMsg).isEqualTo(data.get(32).get("Column5"));
