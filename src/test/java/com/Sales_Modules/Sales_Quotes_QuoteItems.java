...
//		WebdriverWait.findElement("link", "Quote Items").click();
		...
		for(int i=1; i<=7; i++) {
			...
			if(i==1) {
				...
				Sales_QuotesItems_softAssert.assertThat(all_ValidationMsg).isEqualTo(data.get(39).get("Column10"));
			} else if (i == 6) {
				Sales_QuotesItems_softAssert.assertThat(all_ValidationMsg).isEqualTo(data.get(0).get("Column8"));
			} else if (i == 7) {
				Sales_QuotesItems_softAssert.assertThat(all_ValidationMsg).isEqualTo(data.get(2).get("Column9"));
			}
	}
	}
...
//			WebdriverWait.findElement("link", "Quote Items").click();
	...
	public static void Validate_Qty_with_Spl_Characters(List<HashMap<String, String>> data, List<HashMap<String, String>> data_Positive) {
			...
			Sales_QuotesItems_softAssert.assertThat(validationMsg).isEqualTo(data.get(40).get("Column10"));
			String validationMsg1 = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li[2]").getText();
			Sales_QuotesItems_softAssert.assertThat(validationMsg1).isEqualTo(data.get(39).get("Column10"));
			//WebdriverWait.findElement("name", "quantity").clear();
//			WebdriverWait.findElement("link", "Quote Items").click();
	}
	...
	public static void Validate_Qty_with_Neg_Value(List<HashMap<String, String>> data, List<HashMap<String, String>> data_Positive) {
		...
		Sales_QuotesItems_softAssert.assertThat(validationMsg1).isEqualTo(data.get(40).get("Column10"));
		String validationMsg2 = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li[2]").getText();
		Sales_QuotesItems_softAssert.assertThat(validationMsg2).isEqualTo(data.get(39).get("Column10"));
	//	WebdriverWait.findElement("name", "quantity").clear();
//		WebdriverWait.findElement("link", "Quote Items").click();
	}
...
//		disc_dd.selectByVisibleText("-Select-");
		disc_dd.selectByVisibleText("Percentage");
...
//			Sales_QuotesItems_softAssert.assertThat(validationMsg1).isEqualTo(data.get(1).get("Column14"));
			Sales_QuotesItems_softAssert.assertThat(validationMsg1).isEqualTo("Enter a valid Discount");
			}
		}catch(Exception e) {
...
//		WebdriverWait.findElement("link", "Quote Items").click();
	...
	public static void Add_Products_NegativeScenario(List<HashMap<String, String>> data) throws InterruptedException {
...
//		WebElement editQty = driver.findElement(By.id("quantity_0"));
		WebElement editQty = driver.findElement(By.id("quantity_1"));
		editQty.clear();
...
//		WebdriverWait.findElement("id", "discount_0").clear();
		WebdriverWait.findElement("id", "discountStr_1").clear();
		click_Update_Btn();
//		Lakshmi
//		String validationMsg = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li").getText();
		String validationMsg = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div").getText();
...
//		Select disc_dd = new Select(WebdriverWait.findElement("id", "discountType_0"));
		Select disc_dd = new Select(WebdriverWait.findElement("id", "discountType_1"));
		disc_dd.selectByVisibleText("-Select-");
		click_Update_Btn();
//		String validationMsg = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li").getText();
		String validationMsg = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div").getText();
	...
	public static void Validate_alert_message_while_removing_lineItem(List<HashMap<String, String>> data) {
		try {
		WebdriverWait.findElement("xpath", "//*[@id='updateQuoteItem']/table/tbody/tr/td[13]").click();
