...
public class Sales_SalesOrder extends Base {
	...
	public static void SO_StartOrder(List<HashMap<String, String>> data, String soname, String payterm) throws InterruptedException {
...
//		WebdriverWait.findElement("name", "orderName").sendKeys(soname);
	...
	public static void SO_Shipping_Details_SingleFacility(List<HashMap<String, String>> data) {
		...
		WebdriverWait.findElement("xpath", "//*[text()='Add']").click();
		WebdriverWait.findElement("xpath", "//*[text()='Continue']").click();
...
//			supplierPartyId_dd.selectByVisibleText(data.get(13).get("Column2"));
		    ...
		    //18-8-2021
			// added by goutham 
			//purpose enabaling drop shipment condition during adding product to kart
//			Select dropshipment_dd = new Select(WebdriverWait.findElement("id", "dropShipReq"));
			//dropshipment_dd.selectByVisibleText("Yes");
			
//			WebdriverWait.findElement("id", "select2-supplierPartyId-container").sendKeys(data.get(13).get("Column2"));
...
//		alert.accept();
	...
	public static void SO_ReviewCreateSO_Negative(String sheetname) throws InterruptedException {

		WebdriverWait.findElement("link", "Create").click();
//		Alert alert = driver.switchTo().alert();
//		alert.accept();
		Sales_SalesOrder_View.Capture_SONum_Negative_Facility(sheetname);
	}
	...
	public static void Search_SO(List<HashMap<String, String>> data) {
		...
		WebdriverWait.findElement("xpath", "//*[@class='buttontext']").click();
...
//		alert.accept();
	...
	public static void Edit_Adjustments(List<HashMap<String, String>> data) {
		...
		Select fac = new Select(WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[8]/div[2]/form[2]/table/tbody/tr[1]/td[4]/select"));
...
//			}
	...
	public static void navigateToShippingDetailsPage(List<HashMap<String, String>> data_Positive, String payterm) throws InterruptedException {
...
//		Lakshmi - 29/10/2021
		...
		WebdriverWait.findElement("xpath", "(//*[@class='select2-selection__rendered'])[2]").click();
		WebdriverWait.findElement("xpath", "//*[@class='select2-search__field']").sendKeys("Chennai Warehouse");
		WebdriverWait.findElement("xpath", "//*[@class='select2-search__field']").sendKeys(Keys.ENTER);
//		shpFacility.selectByIndex(1);
//		Select shpToAddrr = new Select(WebdriverWait.findElement("id", "0_contactMechId"));
		
		WebdriverWait.findElement("xpath", "(//*[@class='select2-selection__rendered'])[4]").click();
		WebdriverWait.findElement("xpath", "//*[@class='select2-search__field']").sendKeys("Workphillia");
		WebdriverWait.findElement("xpath", "//*[@class='select2-search__field']").sendKeys(Keys.ENTER);
//		shpToAddrr.selectByIndex(1);
		
		WebdriverWait.findElement("xpath", "//*[@name='1_shipAfterDate_i18n']").sendKeys(data.get(8).get("Column1"));
		
		WebdriverWait.findElement("xpath", "//*[@name='1_shipBeforeDate_i18n']").sendKeys(data.get(7).get("Column1"));
...
//		WebdriverWait.findElement("id", "0_shipBeforeDate_i18n").clear();
		WebdriverWait.findElement("xpath", "//*[@name='1_shipBeforeDate_i18n']").clear();
		
//		WebdriverWait.findElement("id", "0_shipAfterDate_i18n").clear();
		WebdriverWait.findElement("xpath", "//*[@name='1_shipAfterDate_i18n']").clear();		
		
		String validationMsg1 = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li[1]").getText();
		Sales_SO_softAssert.assertThat(validationMsg1).isEqualTo(data.get(39).get("Column2"));

		String validationMsg2 = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li[2]").getText();
		Sales_SO_softAssert.assertThat(validationMsg2).isEqualTo(data.get(38).get("Column2"));
	}
...
//		Lakshmi
//		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[2]/div[1]/ul/li[2]/a").click();// New Ship Group
		WebdriverWait.findElement("xpath", "//*[text()='Add']").click();
		
//		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[2]/div[2]/form/table[3]/tbody/tr[1]/td[2]/a").click();// Remove Ship Group
//			Lakshmi - 29/10/2021																																				
...
//			if (driver.findElement(By.xpath("//*[@id='content-main-section']/div[2]/div[2]/form/table[3]/tbody/tr[1]/td[1]/h1")).isDisplayed())
			if (driver.findElement(By.xpath("(//*[@class='screenlet-body']/form/table[2]/tbody//*[@class='select2-selection select2-selection--single'])[1]")).isDisplayed())
...
//		Lakshmi - 08/11/2021
		WebdriverWait.findElement("id", "maxDate_i18n").sendKeys(Keys.ENTER);
//		try {
//			Thread.sleep(2000);
...
//		}
		...
		WebElement searchclick = WebdriverWait.findElement("xpath", "//*[@value='Search']");
	...
	public static void Validate_Qty_with_SPL_characters(List<HashMap<String, String>> data, List<HashMap<String, String>> data_Positive) {
		...
		WebdriverWait.findElement("name", "submitItems").click();
		String actMsg = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li").getText();
		Sales_SO_softAssert.assertThat(actMsg).isEqualTo(data.get(40).get("Column10"));
	}
	...
	public static void Validate_Qty_with_Negative_Value(List<HashMap<String, String>> data, List<HashMap<String, String>> data_Positive) {
		...
		WebdriverWait.findElement("name", "submitItems").click();
		String actMsg = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li").getText();
		Sales_SO_softAssert.assertThat(actMsg).isEqualTo(data.get(39).get("Column10"));
	}
	...
	public static void Validate_without_DropShip(List<HashMap<String, String>> data, List<HashMap<String, String>> data_Positive) throws InterruptedException {
		...
		Select dept_dd = new Select(WebdriverWait.findElement("id", "departmentName"));
		dept_dd.selectByVisibleText(data_Positive.get(0).get("Column8"));
		System.out.println("before drop ship");
		
	    WebElement element = WebdriverWait.findElement("xpath", "//span[@aria-labelledby='select2-dropShipReq-container']");
	    element.click();
		...
		// Select dropShip_dd = new Select(WebdriverWait.findElement("id", "dropShipReq"));
	...
	public static void Validate_RemoveSelected_without_selecting_lineItem(List<HashMap<String, String>> data, List<HashMap<String, String>> data_Positive) throws InterruptedException {
		clearFields();
		WebdriverWait.findElement("name", "add_product_id").sendKeys(data_Positive.get(0).get("Column2"));
...
//		WebdriverWait.findElement("link", "Continue").click();
	...
	public static void Create_SO_For_NegativeFlow(List<HashMap<String, String>> data_Positive, String sheetPositiveData, String payterm) throws InterruptedException {
		// NavigateToCreateSO();
