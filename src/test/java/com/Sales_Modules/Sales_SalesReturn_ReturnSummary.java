...
//		String getStatus = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[3]/div[2]/table/tbody/tr[2]/td[4]").getText();
		String getStatus = WebdriverWait.findElement("xpath", "(//*[@class='screenlet-body'])[2]/table/tbody/tr[2]/td[4]").getText();
...
//		String getStatus = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[4]/div[2]/table/tbody/tr/td[4]").getText();
		String getqty = WebdriverWait.findElement("xpath", "(//*[@class='screenlet-body'])[3]/table/tbody/tr/td[4]").getText();
		Assert.assertEquals(getqty, data.get(0).get("Column27"));
	}
