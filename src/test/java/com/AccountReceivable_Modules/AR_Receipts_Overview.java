...
public class AR_Receipts_Overview extends Base {
	...
	public static void ConfirmPayment() throws InterruptedException {
		...
		WebElement e = WebdriverWait.findElement("xpath", "//a[.=' Confirm']");
		WebDriverWait w = new WebDriverWait(Base.driver, 300);
		w.until(ExpectedConditions.elementToBeClickable(e));

		e.click();

		String Pymt_Status = WebdriverWait
				.findElement("xpath", "//*[@id='content-main-section']/div[3]/div[2]/table/tbody[1]/tr[2]/td[4]")
				.getText();
		Assert.assertEquals("Confirmed", Pymt_Status);
		Thread.sleep(1000);
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[5]/div[2]/table/tbody/tr[2]/td[3]/a")
				.click();// Click
							// POnum
							// SOnum
	}
	...
	public static void Validate_BackToPayment_link_navigating_to_ReceiptOverviewPage() {
		...
		AR_ReceiptsOverview_softAssert.assertThat(verifyReceiptOverviewPageIsDisplayed)
				.isEqualTo("Crest: Payment Overview");
	}

	public static void Validate_Cancel_without_voidReason(List<HashMap<String, String>> data) {
		WebdriverWait.findElement("link", "Cancel").click();
		WebdriverWait
				.findElement("xpath", "//*[@id='content-main-section']/form/div/div[2]/table/tbody[1]/tr[2]/td/input")
				.click();
	...
	public static void Validate_VoidReason_255Char(List<HashMap<String, String>> data) {
		...
		WebdriverWait
				.findElement("xpath", "//*[@id='content-main-section']/form/div/div[2]/table/tbody[1]/tr[2]/td/input")
				.click();
		String getVoidReason = WebdriverWait
				.findElement("xpath", "//*[@id='content-main-section']/div[3]/div[2]/table/tbody[1]/tr[2]/td[4]")
				.getText();
