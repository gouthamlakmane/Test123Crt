...
public class AR_SalesInvoice_Overview extends Base {
	...
	public static void STO_Invoice_Post() {

		WebdriverWait.findElement("link", "Post").click();
		String sto_invId_status = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[2]/div[2]/table/tbody[1]/tr[6]/td[4]").getText();
		Assert.assertEquals("Posted", sto_invId_status);
	}
	...
	public static void SI_Inv1_SubTotal_Validations(List<HashMap<String, String>> data, int row, String col) throws InterruptedException {
...
//		System.out.println(orderItemsTable.size());
		...
		for (int a = 1; a <= orderItemsTable.size(); a++) {
			...
			if (subTotal.contains("Sub Total (Item base Price)")) {
				...
				SI_View_softAssert.assertThat(data.get(row).get(col)).as("SI_Inv1_SubTotal_Validations").isEqualTo(SubTotal);
				System.out.println("SI Sub Total validated Successfully");
			}
		}
	}

	public static void SI_Inv1_Tax_Val(List<HashMap<String, String>> data, int row, String col) throws InterruptedException {
	...
	public static void SI_Inv1_GrdTotal_Val(List<HashMap<String, String>> data, int row, String col) throws InterruptedException {
	...
	public static void Inv1_HeaderAmt_Val(List<HashMap<String, String>> data) {
		...
		String headerAmt = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[4]/div[2]/table/tbody[1]/tr[5]/td[2]")
				.getText().replace(",","");

		SI_View_softAssert.assertThat(headerAmt).as("Inv1_HeaderAmt_Val").isEqualTo(data.get(13).get("Column9"));

	}

	public static void Inv2_HeaderAmt_Val(List<HashMap<String, String>> data) {

		String headerAmt = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[4]/div[2]/table/tbody[1]/tr[5]/td[2]").getText().replace(",",
						"");

		SI_View_softAssert.assertThat(headerAmt).as("Inv2_HeaderAmt_Val").isEqualTo(data.get(14).get("Column9"));
	...
	public static void Inv3_HeaderAmt_Val(List<HashMap<String, String>> data) {
		...
		SI_View_softAssert.assertThat(headerAmt).as("Inv3_HeaderAmt_Val").isEqualTo(data.get(15).get("Column9"));

	}

	public static void PayTerm_Inv1_Val(List<HashMap<String, String>> data) {

		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[6]/div[1]/div/ul/li[2]/a").click();
	...
	public static void PayTerm_Inv1_PaidAmt_Val(List<HashMap<String, String>> data) {
		...
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[6]/div[1]/div[1]/ul/li[2]/a").click();
	...
	public static void SI_Inv3_TaxBreakup_Table_Val(List<HashMap<String, String>> data) {
		...
		List<WebElement> taxBreakupTable = WebdriverWait.findElements("xpath", "//*[@id='taxContainer']/table/tbody/tr");
		int b = taxBreakupTable.size();
		String totalTax = WebdriverWait.findElement("xpath", "(//*[@class='screenlet-body'])[6]/table/tbody/tr[" + b + "]/td[3]").getText().replace(",", "");
...
//		String getVoidReason = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[2]/div[2]/table/tbody[1]/tr[10]/td[2]").getText();
		String getVoidReason = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']//table/tbody[1]/tr[10]/td[2]").getText();
...
//		String getStatus = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[2]/div[2]/table/tbody[1]/tr[8]/td[2]").getText();
		String getStatus = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']//table/tbody[1]/tr[8]/td[2]").getText();
