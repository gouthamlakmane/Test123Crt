...
public class AR_SalesInvoice extends Base {
	...
	public static void SO_InvoicePosting(List<HashMap<String, String>> data, int row) throws InterruptedException {
	...
	public static void Validating_SalesInvoice_date_range_with_invalid_date(List<HashMap<String, String>> data) {
		...
		// "fromInvoiceDate_i18n").sendKeys(data.get(8).get("Column1"));
		// // Issue Due Date - From
		// WebdriverWait.findElement("id",
		// "fromDueDate_i18n").sendKeys(data.get(7).get("Column1"));
		// String validationMsg2 = WebdriverWait.findElement("xpath",
		// "//*[@id='content-messages']/div/ul/li").getText();
	...
	public static void Validating_without_Mandatory_details(List<HashMap<String, String>> data) {
		...
		String path2 = "]";
		// Exception is there in the application need to alter the looping based on the
		// bug fix
		for (int i = 1; i <= 9; i++) {
...
//				SalesInvoice_softAssert.assertThat(all_ValidationMsg).isEqualTo("Due Date is Required.");
	...
	public static String verify_PartyID_Validation_Msg_for_InvalidData(List<HashMap<String, String>> data, int row,
			String colName) {
		String validationMsg = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li").getText();
	...
	public static void Validate_description_with_more_than_255_Characters(List<HashMap<String, String>> data,
			List<HashMap<String, String>> data_Positive) {
		...
		clickCreateBtn();
		String validationMsg = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li").getText();
//		SalesInvoice_softAssert.assertThat(validationMsg)
//				.isEqualTo("The maximum limit for Description is 255 characters.");
		SalesInvoice_softAssert.assertThat(validationMsg)
		.isEqualTo("The maximum limit for Description is 255 characters");
	}

	public static void Validate_ReferenceNo_with_more_than_255_Characters(List<HashMap<String, String>> data,
			List<HashMap<String, String>> data_Positive) {
		...
		String validationMsg = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li").getText();
		SalesInvoice_softAssert.assertThat(validationMsg)
				.isEqualTo("The maximum limit for Reference No. is 60 characters");
	}

	public static void Validate_without_entering_anydata(List<HashMap<String, String>> data) {
		AR_Main.clickAR();
		AR_Main.clickSalesInvoice();
		clickCreateSalesInvoice();
		clickCreateBtn();
		...
		SalesInvoice_softAssert.assertThat(validationMsg).isEqualTo(data.get(12).get("Column5"));
		String validationMsg1 = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li[2]")
				.getText();
		SalesInvoice_softAssert.assertThat(validationMsg1).isEqualTo(data.get(1).get("Column7"));
	}

	public static void Validate_OrderAggrrNterms_without_entering_anydata(List<HashMap<String, String>> data) {
	...
	public static void Validate_OrderAggrrNterms_with_more_than_255_Characters(List<HashMap<String, String>> data) {
		...
		description.sendKeys(data.get(6).get("Column1"));
		WebdriverWait.findElement("xpath", "//*[@id='termsContainer']/table[1]/tbody[1]/tr[5]/td/input").click();
		String validationMsg = WebdriverWait
				.findElement("xpath", "//*[@id='termsContainer']/table[2]/tbody/tr[1]/td[7]").getText();
		SalesInvoice_softAssert.assertThat(validationMsg).isEqualTo(data.get(6).get("Column1"));
	}

	public static void Validate_OrderAggrrNterms_with_invalid_TermDays(List<HashMap<String, String>> data) {
	...
	public static void Validate_OrderAggrrNterms_with_invalid_TermValue(List<HashMap<String, String>> data) {
	...
	public static void Validate_AddlnParties_PartyID_with_invalidData(List<HashMap<String, String>> data, String col) {
		...
		for (int i = 0; i <= 5; i++) {
			...
			if (i == 3) {
				String validationMsg = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li[1]")
						.getText();
				SalesInvoice_softAssert.assertThat(validationMsg).isEqualTo(data.get(12).get("Column5"));
				String validationMsg1 = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li[2]")
						.getText();
	...
	public static void Validate_AddlnParties_without_RoleType(List<HashMap<String, String>> data,
			List<HashMap<String, String>> data_Positive) {
	...
	public static void CreateSalesInvoice_For_NegFlow(List<HashMap<String, String>> data,
			List<HashMap<String, String>> data_Positive) {
		AR_Main.clickAR();
		AR_Main.clickSalesInvoice();
		clickCreateSalesInvoice();
