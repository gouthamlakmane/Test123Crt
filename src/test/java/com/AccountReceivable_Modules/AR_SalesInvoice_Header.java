...
public class AR_SalesInvoice_Header extends Base {
	...
	public static void SO_Invoice_Approve() throws InterruptedException {

		WebdriverWait.findElement("link", "Header").click();
		WebdriverWait.findElement("id", "referenceNumber").sendKeys("Ref_"+CallRandomNo.setRandomNo(1, 14200));
	...
	public static void STO_Invoice_Approve() throws InterruptedException {

		WebdriverWait.findElement("link", "Header").click();
		WebdriverWait.findElement("id", "referenceNumber").sendKeys("STORef_"+CallRandomNo.setRandomNo(1, 10000));
	
		WebdriverWait.findElement("xpath","//input[@value='Update']").click();
		// driver.switchTo().alert().accept();
		WebdriverWait.findElement("xpath", "//a[.=' Approve']").click();
	}
	...
	public static void Validate_PartyID_with_InvalidData(List<HashMap<String, String>> data, String col, int msg_row,
		...
		for (int i = 0; i <= 5; i++) {
			...
			WebdriverWait.findElement("id", "0_lookupId_partyIdTo").sendKeys(Keys.TAB);
			}
	...
	public static void Validate_ReferenceNo_with_more_than_255_Characters(
		...
		clickUpdateBtn();
		String validationMsg = WebdriverWait.findElement("xpath", "//*[@id='content-messages']/div/ul/li").getText();
		SalesInvoiceHeader_softAssert.assertThat(validationMsg).isEqualTo("The maximum limit for Reference No. is 60 characters");
	}
