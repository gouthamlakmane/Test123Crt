...
public class AR_SalesInvoice_Applications extends Base {
	...
	public static void Inv_Adjustments(List<HashMap<String, String>> data) {
		...
		List<WebElement> payments_toApplyTable = WebdriverWait.findElements("xpath", "//*[@id='content-main-section']/div[6]/div[2]/table/tbody/tr");

		for (int a = 1; a <= payments_toApplyTable.size(); a++) {

			String payID = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[6]/div[2]/table/tbody/tr[" + a + "]/td/a").getText();

			if (payID.equals(data.get(13).get("Column10"))) {

				WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[6]/div[2]/table/tbody/tr[" + a + "]/td[6]/a").click();
			}
...
//		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[4]/div[2]/table/tbody/tr[1]/td[6]/a").click();
		WebdriverWait.findElement("xpath", "(//*[text()='Apply'])[1]").click();
