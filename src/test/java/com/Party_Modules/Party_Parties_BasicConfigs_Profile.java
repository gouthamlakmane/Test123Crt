...
//		System.out.println(availBal);
	...
	public static void Val_BillingAcct_Bal_AfterSO(List<HashMap<String, String>> data) {
		...
		String validateAvailBal = WebdriverWait.findElement("xpath", "//*[@id='updateBillingAccount']//tr[6]//td[2]").getText().replace("₹", "").replace(",", "");
		Assert.assertEquals(availBal , validateAvailBal);
	}
}
