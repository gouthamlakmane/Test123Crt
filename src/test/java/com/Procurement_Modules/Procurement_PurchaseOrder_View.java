...
public class Procurement_PurchaseOrder_View extends Base {
	...
	public static void PO_Tax_Val(List<HashMap<String, String>> data, String Header) {
		...
		for (int a = 1; a <= orderItemsTable.size(); a++) {
			...
			String totalTax = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr[" + a + "]/td[2]").getText();
			if (totalTax.contains("Tax Amount (Consolidated)")) {

				String TotalTax = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr[" + a + "]/td[3]").getText()
								.replace(",", "");
				PO_View_softAssert.assertThat(TotalTax).as("Tax Values are not matching").isEqualTo(data.get(17).get(Header));
	...
	public static void PayTerm_Val(List<HashMap<String, String>> data) {
		...
		System.out.println("payterm value---- > "+WebdriverWait.findElement("xpath", "//*[@id='orderTermsOriginal']/tbody/tr[1]/td[5]").getText());

		
		
		String payterm1 = WebdriverWait.findElement("xpath", "//*[@id='orderTermsOriginal']/tbody/tr[1]/td[5]").getText().replace(",", "");
		System.out.println("data from excel ------ > "+data.get(17).get("Column18"));
	...
	public static void PO_SubTotal_Val(List<HashMap<String, String>> data, String Header) {
		CallJavascriptExecutor.scrollToElement(WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr"));
		List<WebElement> orderItemsTable = WebdriverWait.findElements("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr");
		for (int a = 1; a <= orderItemsTable.size(); a++){
...
//				Lakshmi
				String SubTotal = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr[" + a + "]/td[3]").getText()
								.replace(",", "");
//				String SubTotal = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[10]/div[2]/table/tbody/tr[" + a + "]/td[3]").getText()
//						.replace(",", "");
				System.out.println("SubTotal: " + SubTotal);
				PO_View_softAssert.assertThat(SubTotal).as("PO Sub Total validating wrong").isEqualTo(data.get(17).get(Header));
				System.out.println("................. PO Sub Total validated successfully ............");
			}
		}
	}
	...
	public static void CaptureInvID(String sheetname) {
		...
		CallJavascriptExecutor.scrollToElement(WebdriverWait.findElement("xpath","//td[contains(text(),'Status')]"));
        
		List<WebElement> InvTable = WebdriverWait.findElements("xpath", "//*[@id='content-main-section']/div[8]/div[2]/table/tbody/tr");
	
		for (int i = 1; i <= InvTable.size(); i++)
		{
			WebElement ele= WebdriverWait.findElement("xpath","//*[@id=\"content-main-section\"]/div[8]/div[2]/table/tbody["+i+"]/tr/td[1]/a");
			CallJavascriptExecutor.highLighterElement(ele);
			String InvID = ele.getText();
	...
	public static void InvID_PaymntStatus_Val() {
		...
		List<WebElement> InvID_List = WebdriverWait.findElements("xpath", "//*[@id='content-main-section']/div[8]/div[2]/table/tbody/tr");
	

		for (int Inv = 1; Inv <= InvID_List.size(); Inv++) {
			String Inv_sts = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[8]/div[2]/table/tbody[" + Inv + "]/tr/td[4]").getText();
	...
	public static void PO_WFC_Approvals(List<HashMap<String, String>> data) {
		...
		System.out.println("GrndTotal "+GT);
		...
		if (f <= 1000000.00) {
			...
			String status = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[4]/div[2]/table/tbody/tr[5]/td[2]").getText();
	...
	public static void PO_Multilevel_Approval(List<HashMap<String, String>> data, String linkname, String comments) {
		...
		for (int a = 1; a <= notificationTable.size(); a++) {
			String poNum = WebdriverWait.findElement("xpath", "//*[@id='example']/tbody/tr[" + a + "]/td[3]/a").getText();
			if (poNum.contains(data.get(13).get("Column4"))) {
				PO_View_softAssert.assertThat(data.get(13).get("Column4")).isEqualTo(poNum);
				WebdriverWait.findElement("xpath", "//*[@id='example']/tbody/tr[" + a + "]/td[3]/a").click();
				break;
			}
		}
	...
	public static void PO_GrdTotal_Val(List<HashMap<String, String>> data, String Header) {
		...
		for (int a = 1; a <= orderItemsTable.size(); a++)
             {
				String grandTotal = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr[" + a + "]/td[2]").getText();
				if (grandTotal.contains("Grand Total")) 
			    		{
							String GrandTotal = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[7]/div[2]/table/tbody/tr[" + a + "]/td[3]")
											.getText().replace(",", "");
							System.out.println("GrandTotal value is: " + GrandTotal);
							PO_View_softAssert.assertThat(GrandTotal).as("Grand total amount is not matching.").isEqualTo(data.get(17).get(Header));
	...
	public static void Add_Charges(List<HashMap<String, String>> data) throws InterruptedException {
		...
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[12]/div[1]/ul/li[3]/a").click();
	...
	public static void TaxBreakup_Table_Val(List<HashMap<String, String>> data) {
		...
		if (taxType.equalsIgnoreCase("INTRA")) {
			...
			PO_View_softAssert.assertThat(IGST).as("Updated data is not belongs to \"INTER\" state").isEqualTo(data.get(24).get("Column23"));
	...
	public static void ThirdPartyTax_Table_Val(List<HashMap<String, String>> data) {
		...
		System.out.println("Third Party Tax from gui: "+thirdPartyTotalTax);
		PO_View_softAssert.assertThat(thirdPartyTotalTax).as("Third Party Tax Table Validating wrong").isEqualTo(data.get(24).get("Column23"));
	...
	public static void ThirdPartyCharges_Table_Val(List<HashMap<String, String>> data) {
		...
		String thirdPartyTotalCharges = WebdriverWait.findElement("xpath", "//*[@id='tab_tab1_charges']/table/tbody/tr[" + b + "]/td[2]").getText().replace(",",
						"");
		// added by Goutham 3-9-2021
		if(thirdPartyTotalCharges.equals("Tax/Charge Code & Description")) {
			  System.out.println("Third Party Charges are not present..");
		}
		else { 
			PO_View_softAssert.assertThat(thirdPartyTotalCharges).as("validating the ThirdPartyCharges_Table_Val method in Procurement_PurchaseOrder_View class").isEqualTo(data.get(26).get("Column3"));
		}
		System.out.println("Third Party Charges Table validated successfully");
		System.out.println("Procurement_PurchaseOrder_View.ThirdPartyCharges_Table_Val(TC03_data);");
	...
	public static void OtherCharges_PopupBtn_Val(List<HashMap<String, String>> data) {
		...
		System.out.println("Procurement_PurchaseOrder_View.OtherCharges_PopupBtn_Val(TC03_data);");
	}

	public static void Tax_Consolidated_PopupBtn_Val(List<HashMap<String, String>> data) {

		WebElement taxButtonElement = WebdriverWait.findElement("id", "myBtn");
		((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView(true);", taxButtonElement);
		...
		PO_View_softAssert.assertThat(TotalTax).as("Consolidated TotalTaxes are not matching ").isEqualTo(data.get(17).get("Column16"));
		WebdriverWait.findElement("xpath", "//*[@id='myModal']/div/span").click();
		System.out.println("...... Tax(Consolidated) tax amount is matching .....");
	}
...
//						"");
		...
		String TotalTax = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[9]/div[2]/table/tbody/tr[4]/td[3]").getText().replace(",",
				"").replace("₹", "");
		
		
		PO_View_softAssert.assertThat(TotalTax).isEqualTo(data.get(0).get("Column21"));
		System.out.println("Tax Value validated successfully");
	}
...
//		String SubTotal = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[8]/div[2]/table/tbody/tr[2]/td[3]").getText().replace(",",
//				"").replace("₹", "");
		String SubTotal = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[9]/div[2]/table/tbody/tr[2]/td[3]").getText().replace(",",
				"").replace("₹", "");
		
		System.out.println("SubTotal" + SubTotal);
		PO_View_softAssert.assertThat(SubTotal).isEqualTo(data.get(0).get("Column20"));
...
//						"");
		...
		// added by goutham
		String GrandTotal = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[8]/div[2]/table/tbody/tr[5]/td[3]").getText().replace(",",
				"");
		
		
		System.out.println("GrandTotal" + GrandTotal);
		PO_View_softAssert.assertThat(GrandTotal).isEqualTo(data.get(0).get("Column17"));
...
//		Lakshmi
		PO_View_softAssert.assertThat(val).isEqualTo(data.get(31).get("Column12"));
...
//		Lakshmi(Data Changed in Excel)
	...
	public static void CancelOrder() {
		...
		WebdriverWait.findElement("name", "workflowComments").sendKeys("Testing purpose");
//		Lakshmi
//		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div/div[2]/form/div/table/tbody[1]/tr[3]/td[2]/input").click();
		WebdriverWait.findElement("xpath", "//a[.='Cancel Order']").click();
//		Lakshmi
//		String cancelStatus = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[3]/div[2]/table/tbody/tr[5]/td[2]").getText();
		String cancelStatus = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[4]/div[2]/table/tbody/tr[5]/td[2]").getText();
...
//		PO_View_softAssert.assertThat(cancelledNotes).contains("Testing purpose");
//		String cancelledNotes = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[16]/div[2]/table/tbody/tr[2]/td[1]").getText();
//		PO_View_softAssert.assertThat(cancelledNotes).contains("Internal Notes Testing purpose");
...
//		PO_View_softAssert.assertThat(purExe).contains("Purchase Executive (11792)");
		PO_View_softAssert.assertThat(purExe).contains("Kailash R (11731)");
