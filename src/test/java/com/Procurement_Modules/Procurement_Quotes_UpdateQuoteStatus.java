...
public class Procurement_Quotes_UpdateQuoteStatus extends Base {
	...
	public static void Select_OrderType() {
		...
		ordType.selectByVisibleText("Normal");
	}
...
//		Lakshmi(Data Modified in Excel)
		PO_UpdateQuoteStatus_softAssert.assertThat(qty).isEqualTo(data.get(31).get("Column10"));
...
//		Lakshmi
	...
	public static void UpdateQuoteStatus_AddingComments_255Char(List<HashMap<String, String>> data) {
		...
		WebdriverWait.findElement("id", "comments").sendKeys(data.get(32).get("Column1"));
	...
	public static void UpdateQuoteStatus_Addinglineitems(List<HashMap<String, String>> data, List<HashMap<String, String>> Inv_data) {
		...
		for (int a = 0; a <= 4; a++) {
			...
			WebdriverWait.findElement("id", "comments").sendKeys(Inv_data.get(32).get("Column1"));
	...
	public static void UpdateQuoteStatus_Editlineitems_InvalidQty(List<HashMap<String, String>> data) {
		...
		PO_UpdateQuoteStatus_softAssert.assertThat(qty_req).isEqualTo(data.get(31).get("Column10"));
...
//		Lakshmi
	...
	public static void AddingQuotesNotes_255Char(List<HashMap<String, String>> data){
		...
		WebdriverWait.findElement("id", "noteName").sendKeys(data.get(32).get("Column1"));
		WebdriverWait.findElement("id", "noteInfo").sendKeys(data.get(32).get("Column1"));
...
//		String notes_info = WebdriverWait.findElement("xpath", "//*[@id= 'content-messages']/div/ul/li[1]").getText();
...
//		PO_UpdateQuoteStatus_softAssert.assertThat(prdID).contains("BRUFT201");
		PO_UpdateQuoteStatus_softAssert.assertThat(prdID).contains("BECTC028");
