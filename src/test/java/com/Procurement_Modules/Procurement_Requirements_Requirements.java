...
public class Procurement_Requirements_Requirements extends Base {
	...
	public static void PO_Req_Inv_Adhoc(List<HashMap<String, String>> data, String sheetname)
	...
	public static void PO_Req(List<HashMap<String, String>> data, String sheetname, String orderType)
			throws InterruptedException {
...
//		Lakshmi
		...
		WebElement reqclick = driver.findElement(By.xpath("//a[text()=' Requirements']"));
		reqclick.click();
	}
	...
	public static void Req_SearchPage_InvalidDate_Val(List<HashMap<String, String>> data) {
		...
		String reqBy_ThruDate = WebdriverWait.findElement("xpath", "//*[@id= 'content-messages']/div/ul/li[3]")
				.getText();
		String reqBy_FromDate = WebdriverWait.findElement("xpath", "//*[@id= 'content-messages']/div/ul/li[4]")
				.getText();
	...
	public static void Invalid_reqByDate_CreateReqTable(List<HashMap<String, String>> data) {
		...
		String requiredByDate = WebdriverWait.findElement("xpath", "//*[@id= 'content-messages']/div/ul/li[1]")
				.getText();
	...
	public static void Req_Mandatory_Fields_ReqItemTable(List<HashMap<String, String>> data) {
		...
		String qty_moreThan0 = WebdriverWait.findElement("xpath", "//*[@id= 'content-messages']/div/ul/li[2]")
				.getText();
		...
		String orderItem_Type = WebdriverWait.findElement("xpath", "//*[@id= 'content-messages']/div/ul/li[5]")
				.getText();
//		Lakshmi
//		PO_Req_softAssert.assertThat(qty_Req).isEqualTo(data.get(0).get("Column10"));
		PO_Req_softAssert.assertThat(qty_Req).isEqualTo(data.get(31).get("Column10"));
...
//		PO_Req_softAssert.assertThat(requiredByDate).isEqualTo(data.get(4).get("Column2"));
		PO_Req_softAssert.assertThat(requiredByDate).isEqualTo(data.get(33).get("Column2"));
	...
	public static void Removing_AddedLineItem(List<HashMap<String, String>> data) {
		...
		String removedMsg = WebdriverWait
				.findElement("xpath", "//*[@id='createRequirements']/div[2]/div[2]/table[2]/tbody/tr/td").getText();
	...
	public static void Val_255Charc_Desc_Reason_CreateReqTable(List<HashMap<String, String>> data) {
		...
		String desc_charclimit = WebdriverWait.findElement("xpath", "//*[@id= 'content-messages']/div/ul/li[1]")
				.getText();
		PO_Req_softAssert.assertThat(desc_charclimit).isEqualTo(data.get(30).get("Column13"));
//		PO_Req_softAssert.assertThat(desc_charclimit).isEqualTo(data.get(5).get("Column13"));
//		Lakshmi
//		String reason_charclimit = WebdriverWait.findElement("xpath", "//*[@id= 'content-messages']/div/ul/li[2]")
//				.getText();
		String reason_charclimit = WebdriverWait.findElement("xpath", "//*[@id= 'content-messages']/div/ul/li")
				.getText();
		PO_Req_softAssert.assertThat(reason_charclimit).isEqualTo(data.get(35).get("Column13"));
//		PO_Req_softAssert.assertThat(reason_charclimit).isEqualTo(data.get(6).get("Column13"));

	}

	public static void te(List<HashMap<String, String>> data, String sheetname, String orderType)
			throws InterruptedException {
		log.info("Adding products for Requirements");
		for (int p = 0; p <= 4; p++) {
	...
	public static void Req_Mandatory_Fields_EditReqTable(List<HashMap<String, String>> data) {
		...
		String reqType = WebdriverWait.findElement("xpath", "//*[@id= 'content-messages']/div/ul/li[5]").getText();
		PO_EditReq_softAssert.assertThat(reqType).isEqualTo(data.get(1).get("Column6"));
	...
	public static void Invalid_reqByDate_EditReqTable(List<HashMap<String, String>> data) {
		...
		String requiredByDate = WebdriverWait.findElement("xpath", "//*[@id= 'content-messages']/div/ul/li[1]")
				.getText();
		PO_EditReq_softAssert.assertThat(requiredByDate).isEqualTo(data.get(24).get("Column10"));
...
//		PO_EditReq_softAssert.assertThat(qty_Req).isEqualTo(data.get(0).get("Column10"));
	...
	public static void EditReq_Invalid_PrdID(List<HashMap<String, String>> data,
			List<HashMap<String, String>> Inv_data) {
...
//		PO_EditReq_softAssert.assertThat(requiredByDate).isEqualTo(data.get(4).get("Column2"));
		PO_EditReq_softAssert.assertThat(requiredByDate).isEqualTo(data.get(33).get("Column2"));
		WebdriverWait.findElement("id", "itemRequiredByDate_i18n").clear();
	}

	public static void EditReqQty_InvalidData(List<HashMap<String, String>> data,
			List<HashMap<String, String>> Inv_data) {
...
//		Lakshmi
		String Qty = WebdriverWait.findElement("id", "quantity_0").getAttribute("value");//*[@value='150.64']
	...
	public static void Reject_Req(List<HashMap<String, String>> data) {
		...
		String rejectStatus = WebdriverWait
				.findElement("xpath", "//*[@id='editRequirements']/table/tbody[1]/tr[2]/td[4]").getText();
