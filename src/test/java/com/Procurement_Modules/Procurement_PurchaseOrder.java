...
public class Procurement_PurchaseOrder extends Base {
	...
	public static void PO_Shipping_Details_MultipleFacility(List<HashMap<String, String>> data, int loopcount, int facility1, int facility2, int facility3) 
	{
		...
		LinkedHashSet<String> fas = new LinkedHashSet<String>();
		
		for(int a = 0; a <= loopcount; a++) 
		{
			String facilityFromExc = data.get(a).get("Column7");
			fas.add(facilityFromExc); 
		}
		
    	String str = String.join(",", fas);
    	String[] res = str.split("[,]");
			
    for (int a = 0; a <fas.size(); a++) 
		{
			System.out.println("after split "+res[a]);
			WebElement wb =  WebdriverWait.findElement("id", (a+"_facilityId"));
		    Select fac = new Select(wb);
			fac.selectByVisibleText(res[a]);
	...
	public static void PO_Shipping_Details_SingleFacility(List<HashMap<String, String>> data) {
		...
		//Added by Goutham and Purpose GUI changed in Shipping Details Screen
		WebdriverWait.findElement("xpath","//textarea[@name='0_shipping_instructions']").sendKeys("The shipper will confirm the details of the exporting company (shipper) and the company overseas that is receiving the cargo (the consignee).  This requires the company name, address, contact phone number, email address.");;
		WebdriverWait.findElement("xpath", "//a[.='Add']").click();
		WebdriverWait.findElement("link", "Continue").click();
	}
...
//		WebdriverWait.findElement("link", "Create").click();
		WebElement btnclickcreate = driver.findElement(By.xpath("//*[text()='Create']"));
...
//		WebdriverWait.findElement("xpath", "//*[@type='submit']").click();
		try {
			WebdriverWait.findElement("xpath", "//*[@type='submit']").click();
		     ...
		     executor.executeScript("arguments[0].click();", WebdriverWait.findElement("xpath", "//*[@type='submit']"));
		  }
	...
	public static void Edit_Adjustments(List<HashMap<String, String>> data) {
		...
		Procurement_PurchaseOrder_View.EditOrderLink();
		CallJavascriptExecutor.scrollToElement(WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[10]/div[2]/form[2]/table/tbody/tr[1]/td[4]/select"));
			
		Select adj = new Select(WebdriverWait.findElement("name", "orderAdjustmentTypeId"));
		adj.selectByVisibleText("Discount");
       
		Select fac = new Select(WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[10]/div[2]/form[2]/table/tbody/tr[1]/td[4]/select"));
	...
	public static void PurchaseOrder_SearchPage_InvalidDate_Val(List<HashMap<String, String>> data) {
		...
		CallJavascriptExecutor.scrollToElement(WebdriverWait.findElement("xpath", "//*[@value='Search']"));
	...
	public static void PO_StartOrder_MandatoryFields_POtable(List<HashMap<String, String>> data) {
		...
		PO_PurchaseOrder_softAssert.assertThat(PO_Date).isEqualTo(data.get(34).get("Column2"));
		PO_PurchaseOrder_softAssert.assertThat(org_Name).isEqualTo(data.get(1).get("Column4"));
	...
	public static void PO_ShpDetails_MandatoryFields(List<HashMap<String, String>> data) {
		...
		//Added by goutham
		WebdriverWait.findElement("link", "Add").click();
		//WebdriverWait.findElement("link", "Continue").click();
		...
		PO_PurchaseOrder_softAssert.assertThat(shpFromAdd).as("validating Ship From Address ").isEqualTo(data.get(12).get("Column8"));
		PO_PurchaseOrder_softAssert.assertThat(partyBillAdd).as("Party Billing Address ").isEqualTo(data.get(13).get("Column8"));
...
//		PO_PurchaseOrder_softAssert.assertThat(fac).isEqualTo(data.get(4).get("Column8"));
		...
		System.out.println("ShpToAdd field "+ ShpToAdd);
//		Lakshmi
//		PO_PurchaseOrder_softAssert.assertThat(ShpToAdd).isEqualTo(data.get(7).get("Column8"));
		PO_PurchaseOrder_softAssert.assertThat(ShpToAdd).isEqualTo(data.get(33).get("Column8"));
...
//		Lakshmi
		...
		PO_PurchaseOrder_softAssert.assertThat(dept).isEqualTo(data.get(32).get("Column9"));
...
//		PO_PurchaseOrder_softAssert.assertThat(valid_disc).isEqualTo(Inv_data.get(0).get("Column14"));
		PO_PurchaseOrder_softAssert.assertThat(valid_disc).isEqualTo(Inv_data.get(32).get("Column14"));
...
//		Lakshmi(Changed Info in Excel)
	...
	public static void PO_OrderItems_Backbtn() {
		...
		WebdriverWait.findElement("link", "Back").click();
         //AddedEvent by  goutham, since New Ship Group feature is removed
...
//		String intNotes = WebdriverWait
//				.findElement("xpath", "//*[@id='content-main-section']/div[11]/div[2]/table/tbody/tr/td[1]").getText();
//		String supNotes = WebdriverWait
//				.findElement("xpath", "//*[@id='content-main-section']/div[11]/div[2]/table/tbody/tr/td[2]").getText();
//		Lakshmi
		String intNotes = WebdriverWait
				.findElement("xpath", "//*[@id='content-main-section']/div[12]/div[2]/table/tbody/tr/td[1]").getText();
		String supNotes = WebdriverWait
				.findElement("xpath", "//*[@id='content-main-section']/div[12]/div[2]/table/tbody/tr/td[2]").getText();
...
//		Lakshmi(Data modified in excel)
...
//		Lakshmi
//		PO_PurchaseOrder_softAssert.assertThat(qty_num1).isEqualTo(Inv_data.get(2).get("Column10"));
		PO_PurchaseOrder_softAssert.assertThat(qty_num1).isEqualTo(Inv_data.get(32).get("Column10"));
	}
...
//		Lakshmi
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[10]/div[2]/form[2]/table/tbody/tr[3]/td/input").click();
...
//		Select fac_dd = new Select(WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[9]/div[2]/form[2]/table/tbody/tr[1]/td[4]/select"));
		Select fac_dd = new Select(WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[10]/div[2]/form[2]/table/tbody/tr[1]/td[4]/select"));
...
//		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[9]/div[2]/form[2]/table/tbody/tr/td[5]/input").click();
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[10]/div[2]/form[2]/table/tbody/tr/td[5]/input").click();
	...
	public static void PO_Edit_AddOrderItems_MandatoryFields(List<HashMap<String, String>> data) {
		...
		PO_PurchaseOrder_softAssert.assertThat(qty).isEqualTo(data.get(0).get("Column10"));
//		Lakshmi(Data modified in excel)
		PO_PurchaseOrder_softAssert.assertThat(fac).isEqualTo(data.get(32).get("Column8"));
		PO_PurchaseOrder_softAssert.assertThat(uom).isEqualTo(data.get(1).get("Column11"));
...
//		Lakshmi
	...
	public static void PO_Edit_AddOrderItems_AddComments_255Charac(List<HashMap<String, String>> data, List<HashMap<String, String>> Inv_data) {
		...
		String comments = WebdriverWait.findElement("xpath", "//*[@id= 'content-messages']/div/ul/li[1]").getText();
//		Lakshmi
		PO_PurchaseOrder_softAssert.assertThat(comments).isEqualTo(Inv_data.get(32).get("Column13"));
...
//		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[12]/div[2]/table/tbody/tr[1]/td[2]/a[1]").click();
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[13]/div[2]/table/tbody/tr[1]/td[2]/a[1]").click();
...
//		PO_PurchaseOrder_softAssert.assertThat(intNotes).isEqualTo("Update Test");
		String intNotes = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[16]/div[2]/table/tbody/tr/td[1]").getText();
		PO_PurchaseOrder_softAssert.assertThat(intNotes).contains("Update Test");
		Procurement_PurchaseOrder_View.EditOrderLink();
...
//		String addNotes = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[16]/div[2]/table/tbody/tr[2]/td[1]").getText();
//		PO_PurchaseOrder_softAssert.assertThat(addNotes).contains("Add Notes Test");
		Procurement_PurchaseOrder_View.EditOrderLink();

		// Delete Notes
//		Lakshmi
//		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[12]/div[2]/table/tbody/tr[2]/td[2]/a[2]").click();
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[13]/div[2]/table/tbody/tr[2]/td[2]/a[2]").click();
...
//		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[9]/div[1]/ul/li[4]/a").click();
		WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div[10]/div[1]/ul/li[4]/a").click();
